...
public class calculator2 extends Application {
    ...
    public void CreateKeyboard() {
    	...
    	HBox h2=new HBox(10,AllClear,Clear,RBrackets,LBrackets);	//AC,C,(,)
    	h2.setAlignment(Pos.CENTER);
    	HBox h3=new HBox(10,Seven,Eight,Nine,Division);	//7,8,9,÷
    	h3.setAlignment(Pos.CENTER);
    	HBox h4=new HBox(10,Four,Five,Six,Multiplication);//4,5,6,x
    	h4.setAlignment(Pos.CENTER);
    	HBox h5=new HBox(10,One,Two,Three,Subtraction);//1,2,3,-
    	h5.setAlignment(Pos.CENTER);
    	HBox h6=new HBox(10,Zero,Point,Answer,Addition);//0,.,=,+
    	h6.setAlignment(Pos.CENTER);

    	//VBoxでは位置決めしたものをVBoxに配置
    	vb=new VBox(10,h1,h2,h3,h4,h5,h6);
    }
    ...
    public void btnClicked() {
    	...
    	//C
    	Clear.setOnAction(e->{
    		StringBuilder sb = new StringBuilder(tfCalc.getText());
    		sb.deleteCharAt(sb.length()-1);
    		tfCalc.setText(sb.toString());
    	});
    	//AC
